...
import XSyncingContainer from '../../obsidian/components/XSyncing/XSyncingContainer'
import App from './App'
import XAppContainer from '../../obsidian/components/XApp/XAppContainer'
import XPassphraseContainer from '../../obsidian/components/XPassphrase/XPassphraseContainer'
...
const Root = ({
  ...
  // make the router history globally accessible
  window.x1Tools.history = history
            ...
            {isRootReady && (
              <Switch>
                ...
                <Route
                  exact
                  path="/xsyncing"
                  render={() => <XSyncingContainer onClose={redirectToLogout} pb={0} px={0} />}
                />
                <Route
                  path="/xapp"
                  render={() => {
                    return <XAppContainer />
                  }}
                />
