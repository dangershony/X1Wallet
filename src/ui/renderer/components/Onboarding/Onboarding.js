...
import X1ConnectionDetails from '../../../obsidian/X1ConnectionDetails'
import X1ConnectionConfirm from '../../../obsidian/X1ConnectionConfirm'
...
class Onboarding extends React.Component {
  ...
  getSteps = () => {
    ...
    switch (connectionType) {
      ...
      /**
       * Form steps for Obsidian connection flow.
       */
      case 'fullNodeConn':
        formSteps = [
          <Wizard.Step key="X1ConnectionDetails" component={X1ConnectionDetails} {...{}} />,
          <Wizard.Step key="X1ConnectionConfirm" component={X1ConnectionConfirm} {...{}} />,
        ]
        break
    }
