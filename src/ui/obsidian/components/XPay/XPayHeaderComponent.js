 ...
 */
class XPayHeaderComponent extends React.PureComponent {
  static propTypes = {
  ...
  render() {
    ...
    switch (type) {
      case 'onchain':
        ...
        subtitle = <FormattedMessage {...xmessages.subtitle_onchain} />
        break
      case 'offchain':
        logo = <Lightning height="45px" width="45px" />
        subtitle = <FormattedMessage {...xmessages.subtitle_offchain} />
        break
      default:
...
export default XPayHeaderComponent
