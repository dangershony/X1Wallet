...
import AngleLeft from '../../../renderer/components/Icon/AngleLeft'
import AngleRight from '../../../renderer/components/Icon/AngleRight'
import AngleUp from '../../../renderer/components/Icon/AngleUp'
import AngleDown from '../../../renderer/components/Icon/AngleDown'
  ...
  ({ item, onClick, active, theme, hasParent, hasChildren, valueField, ...rest }) => (
    <MenuItemText key={item.key} onClick={() => onClick(item.key)} {...rest}>
      <Flex alignItems="center" pr={2}>
        ...
        <Text mr={2}>{window.x1Tools.translateCryptoUnitName(item[valueField])}</Text>
...
const Dropdown = injectIntl(
  ({
    ...
    const fullNodeCryptoUnitName = 'ABC' // window.x1Tools.translateCryptoUnitName(activeKey)
        ...
        <DropdownContainer {...rest} ref={wrapperRef}>
          ...
          >
            <Flex alignItems="center">
              ...
              >
                {selectedItem
                  ? window.x1Tools.translateCryptoUnitName(selectedItem[valueField])
                  : window.x1Tools.translateCryptoUnitName(activeKey)}{' '}
              </Text>
              <Flex color="gray">
